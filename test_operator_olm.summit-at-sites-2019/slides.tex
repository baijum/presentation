...
\begin{frame}
  ...
  operator.  To run end-to-end test, we need a method to setup the
  infrastructure which includes DevConsole operator deployment and
  other dependent resources (CRDs, service account, role, and role
  binding).
