...
White space is meaningful in Python: especially
indentation and placement of newlines.

\begin{itemize}
\item Use a newline to end a line of code.
\begin{itemize}
\item Use \code{\\} when must go to next line prematurely.
\end{itemize}
\item No braces \code{\{ \}} to mark blocks of code in Python...
...
(E.g. for function definitions and if conditions.)
\end{itemize}
\end{frame}
